...
def docs_view(request, doc_key="feature_list"):
    ...
    docs_map = {
        ...
        "mock_hrms_integration": ("Mock HRMS Integration Guide", "integration.md"),
        "system_whitepaper": ("System Reference Whitepaper", "learn.md"),
        "problem_solving": ("Architectural Decisions & Problem Solving", "problems.solved.md"),
