...
urlpatterns = [
    ...
    path("recruitment/jobs/<int:job_id>/fill/", views.mark_job_filled, name="mark_job_filled"),
    path("recruitment/jobs/<int:job_id>/delete/", views.delete_job, name="delete_job"),
